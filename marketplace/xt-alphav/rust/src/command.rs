...
pub enum Response {
    ...
    ToolList(Vec<alphav::tool_use::ToolInfo>),
    /// Details for a specific tool
    ToolDetails(alphav::tool_use::ToolInfo),
...
pub async fn respond<Client: alphav::Request>(client: &alphav::AlphaVantage<Client>, cmd: Command) -> Response {
    match cmd {
